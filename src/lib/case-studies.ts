...
const ERP_ROLE = ["Product planning", "UI/UX design", "Frontend development", "Backend development", "QA"];

const ERP_CASES: ClientCase[] = [
  {
    slug: "barakah-accounts-restaurant-erp",
    name: "Barakah Accounts",
    headline: "How Barakode helped a restaurant operation bring its daily work into one ERP",
    clientType: "Restaurant operations team",
    industry: "Hospitality & food service",
    track: "internal-systems",
    alsoIn: ["web-mobile"],
    timeline: "Live product",
    liveUrl: "https://app.barakahaccounts.com/",
    engagementModel: "Custom Product Build",
    servicesDelivered: ERP_SERVICES,
    summary: "A restaurant ERP built to bring orders, stock, billing, reporting, and the day-to-day handover between front-of-house and back-office teams into one working system.",
    challenge: ["Restaurant work moves quickly, while information can end up split between counters, spreadsheets, stock records, and end-of-day reports.", "The team needed one dependable workspace for the operational tasks that repeat every day."],
    goals: ["Bring daily operations into one system.", "Make orders, inventory, and billing easier to review.", "Give the team a clearer view of operational activity."],
    solution: ["Barakode delivered a focused ERP workspace shaped around restaurant operations rather than a generic admin template.", "Core records, workflows, and reporting sit together so the team can follow the state of the business without stitching separate tools together.", "NestJS provides the application layer, PostgreSQL stores structured operational data, and Redis supports responsive workflows."],
    featuresDelivered: ["Order management", "Inventory records", "Billing workflows", "Operational reporting", "Role-based access", "Central business records"],
    stack: ERP_STACK,
    role: ERP_ROLE,
    results: ["Live restaurant ERP available at app.barakahaccounts.com."],
    lessons: ["The useful ERP is the one staff can use during a busy shift, not the one with the longest feature list.", "Keeping orders, stock, and billing close together makes daily handovers easier to follow."],
    cover: "/images/case-studies/erp-systems/restaurant-erp.webp",
    coverAlt: "Illustrative dashboard image representing a restaurant operations ERP",
    screenshots: [],
    tone: "dark",
  },
  {
    slug: "ophir-jewellery-erp",
    name: "Ophir Jewellery ERP",
    headline: "How Barakode helped a jewellery business organise its operations in one ERP",
    clientType: "Jewellery business",
    industry: "Jewellery retail & operations",
    track: "internal-systems",
    alsoIn: ["web-mobile"],
    timeline: "Live product",
    liveUrl: "https://ophir.eaquirstech.com/",
    engagementModel: "Custom Product Build",
    servicesDelivered: ERP_SERVICES,
    summary: "An ERP for a jewellery operation that brings product records, stock, customer activity, order handling, and business reporting into one calmer working view.",
    challenge: ["Jewellery operations depend on accurate product and stock information, yet the work can become fragmented when customer activity, orders, and records live in separate places.", "The business needed an internal system that made important details easy to review without making routine work feel heavy."],
    goals: ["Create one source of truth for core operations.", "Support clearer product, stock, customer, and order workflows.", "Give the team a practical reporting view for everyday decisions."],
    solution: ["Barakode built an ERP workspace that connects operational records instead of treating each department as a separate tool.", "The interface lets teams move from product information to orders and supporting records without losing context.", "NestJS, PostgreSQL, and Redis provide a reliable foundation for connected records and responsive workflows."],
    featuresDelivered: ["Product catalogue", "Inventory management", "Customer records", "Order workflows", "Billing support", "Business reporting"],
    stack: ERP_STACK,
    role: ERP_ROLE,
    results: ["Live jewellery ERP available at ophir.eaquirstech.com."],
    lessons: ["A product record becomes more useful when it stays connected to the order and customer context around it.", "Clear operational screens help teams trust the data they work from."],
    cover: "/images/case-studies/erp-systems/jewellery-erp.webp",
    coverAlt: "Illustrative dashboard image representing a jewellery ERP",
    screenshots: [],
    tone: "dark",
  },
  {
    slug: "turner10-real-estate-erp",
    name: "Turner 10 Real Estate ERP",
    headline: "How Barakode helped a real-estate team manage its operational work in one system",
    clientType: "Real-estate operations team",
    industry: "Real estate",
    track: "internal-systems",
    alsoIn: ["web-mobile"],
    timeline: "Live product",
    liveUrl: "https://turner10.eaquirstech.com/",
    engagementModel: "Custom Product Build",
    servicesDelivered: ERP_SERVICES,
    summary: "A real-estate ERP that gives the team one practical place to follow properties, enquiries, availability, client records, and the internal work that supports every deal.",
    challenge: ["Property information changes quickly and the commercial work around it crosses listings, client conversations, documents, and availability.", "The team needed an internal system that kept those moving parts connected while remaining simple enough for daily use."],
    goals: ["Centralise property and operational records.", "Give teams a clearer view of enquiries and availability.", "Reduce the effort required to move between client, property, and document context."],
    solution: ["Barakode delivered an ERP that organises the work around the property lifecycle: the portfolio, the people involved, the current status, and the supporting records.", "The product is structured as a working system rather than a brochure database, with operational views that make the next action easier to see.", "NestJS, PostgreSQL, and Redis provide the foundation for connected records and responsive workflows."],
    featuresDelivered: ["Property portfolio records", "Enquiry tracking", "Availability management", "Client records", "Document workflows", "Operational reporting"],
    stack: ERP_STACK,
    role: ERP_ROLE,
    results: ["Live real-estate ERP available at turner10.eaquirstech.com."],
    lessons: ["A property record is only useful when the client, availability, and next task around it are easy to reach.", "Internal systems work best when they reflect the real handoffs in a team."],
    cover: "/images/case-studies/erp-systems/real-estate-erp.webp",
    coverAlt: "Illustrative dashboard image representing a real-estate ERP",
    screenshots: [],
    tone: "dark",
  },
  {
    slug: "ehms-hospital-erp",
    name: "EHMS Hospital ERP",
    headline: "How Barakode helped a hospital operation organise core workflows in one ERP",
    clientType: "Hospital operations team",
    industry: "Healthcare administration",
    track: "internal-systems",
    alsoIn: ["web-mobile"],
    timeline: "Live product",
    liveUrl: "https://ehms.eaquirstech.com/",
    engagementModel: "Custom Product Build",
    servicesDelivered: ERP_SERVICES,
    summary: "A hospital ERP designed to bring administrative and operational workflows into one working system, from patient administration and appointments to records, billing, and day-to-day reporting.",
    challenge: ["Hospital operations involve many connected handoffs. When administration, appointments, billing, and records are separated, teams lose time finding the context they need.", "The requirement was a practical internal system that could support the work without turning every interaction into a complicated process."],
    goals: ["Centralise core administrative workflows.", "Make appointments, records, billing, and operational status easier to follow.", "Support clear access to the information each team needs."],
    solution: ["Barakode built a hospital ERP that gives administrative teams a connected operational workspace rather than a collection of disconnected screens.", "The product organises administration, appointment handling, records, and supporting business workflows into a clearer day-to-day process.", "NestJS, PostgreSQL, and Redis provide structured records and responsive application behaviour."],
    featuresDelivered: ["Patient administration", "Appointment workflows", "Operational records", "Billing support", "Role-based access", "Administrative reporting"],
    stack: ERP_STACK,
    role: ERP_ROLE,
    results: ["Live hospital ERP available at ehms.eaquirstech.com."],
    lessons: ["In a hospital system, clarity between administrative handoffs is as important as the individual screens.", "Role-aware access keeps operational information useful without giving every user the same view."],
    cover: "/images/case-studies/erp-systems/hospital-erp.webp",
    coverAlt: "Illustrative dashboard image representing a hospital ERP",
    screenshots: [],
    tone: "dark",
  },
];

CLIENT_CASES.push(...ERP_CASES);
